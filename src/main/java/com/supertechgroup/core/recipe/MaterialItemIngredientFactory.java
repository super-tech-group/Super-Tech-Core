...
public class MaterialItemIngredientFactory implements IIngredientFactory {

	public static class MaterialItemIngredient extends Ingredient implements IIngredientFactory {
		...
		public Ingredient parse(JsonContext context, JsonObject json) {
			...
			return new MaterialItemIngredient(MaterialItem.getTypeFromString(JsonUtils.getString(json, "item")),
					reqs.toArray(new MaterialIngredientCriteria[0]));
		}

		public String toString() {
			return "{type:" + this.type + "," + Arrays.toString(this.criteria) + "}";
		}
	}
	...
	public Ingredient parse(JsonContext context, JsonObject json) {
		...
		MaterialItemIngredient mii = new MaterialItemIngredient(
				MaterialItem.getTypeFromString(JsonUtils.getString(json, "item")),
				reqs.toArray(new MaterialIngredientCriteria[0]));
