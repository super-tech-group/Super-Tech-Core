...
public class CrudeCouplingBlock extends Block implements ITileEntityProvider {
	public CrudeCouplingBlock() {
		super(Material.ROCK);
		this.setUnlocalizedName(Reference.MODID + ".crudeCoupling");
		this.setRegistryName(Reference.MODID, "crudeCoupling");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new CrudeCouplingTileEntity();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (!world.isRemote) {
			CrudeCouplingTileEntity te = (CrudeCouplingTileEntity) world.getTileEntity(pos);
