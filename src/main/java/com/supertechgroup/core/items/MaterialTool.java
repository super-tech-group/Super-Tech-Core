...
public class MaterialTool extends ItemTool {
	...
	public MaterialTool(Material materialIn, int toolType) {
		...
		setUnlocalizedName(Reference.MODID + ".tool" + materialIn.getName() + toolType);
	...
	private void damageTool(ItemStack stack, int amount, Random rand, @Nullable EntityLivingBase entityLiving) {
		...
		int curDamage = Helpers.getNBTInt(stack, nbtKey);
		curDamage += amount;
		...
		Helpers.setNBTInt(stack, nbtKey, curDamage);
	}
	...
	public double getDurabilityForDisplay(ItemStack stack) {
		return Helpers.getNBTInt(stack, "toolDMG") / (double) material.getMaxToolDamage(stack.getMetadata());
	}
