...
public class ShapedResearchRecipe extends ShapedOreRecipe {
	 ...
	 * @param rr
	 */
	public void addResearchUnlock(ResearchRequirement rr) {
	...
	public boolean matches(InventoryCrafting inv, World world) {
		...
		return p != null && req.isFulfilled(team) && super.matches(inv, world);
	}
