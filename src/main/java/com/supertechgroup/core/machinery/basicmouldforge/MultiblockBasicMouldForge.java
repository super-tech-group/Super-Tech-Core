...
public class MultiblockBasicMouldForge implements IMultiblock {
	static BlockMatcher[][][] structure = new BlockMatcher[][][] {
			...
			{ { new DirectBlockMatcher(ModRegistry.crudeIOBlock) },
					{ new DirectBlockMatcher(ModRegistry.crudeCouplingBlock) },
	...
	public String getUniqueName() {
		// TODO Auto-generated method stub
		return Reference.MODID + ":BasicMouldForge";
	}
